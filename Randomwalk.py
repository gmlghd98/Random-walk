...
bug_num = int(input("Bug num: "))

bar_loc = [random.randrange(0, box_size), random.randrange(0, box_size)] #술집 위치 -> 사용자 입력: 크기
print("Bar Location: ", bar_loc, "\n")

#초기 벌레 위치 배열
bug_loc = [[random.randrange(0, box_size), random.randrange(0, box_size)] for i in range(bug_num)] #사용자 입력: 크기 & 벌레 수

bug_test = Drunken_bug(box_size, bug_num, bug_loc, bar_loc)  #사용자 입력: 크기 & 벌레 수
